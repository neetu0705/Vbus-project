...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><section class="main-heading " id="About" >VBus Online Ticketing</a>
    </div>
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			...
			 			<p>Departure Date: <?= $_SESSION['departure_date']; ?>    from 9:00AM </p>
			 		</strong>
			 			<i>Estimated Arrival Time: The Next Day  at 3:00PM</i><br />
			 			<strong>
